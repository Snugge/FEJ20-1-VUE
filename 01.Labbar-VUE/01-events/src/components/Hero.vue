<template>
<div class="my-5 py-5 z-depth-1 container">
...
<section class="px-md-5 mx-md-5 text-center dark-grey-text">
	...
	<div class="col-xl-6 col-md-8">
		...
		<a v-on:click="myClick()" class="btn btn-info btn-lg ml-0 mb-5" href="#" role="button">{{ btnText }}<i class="fa fa-magic ml-2"></i></a>
...
export default {
	...
	methods: {
		myClick: function() {
			this.click++
			console.log("Du klickade på knappen! " +this.click+ " gånger");
		}
	}
